...
import org.haziffe.dropsauce.alternatives.ui.AlternativesActivity
import org.haziffe.dropsauce.backups.ui.backup.BackupDialogFragment
import org.haziffe.dropsauce.backups.ui.restore.RestoreDialogFragment
import org.haziffe.dropsauce.bookmarks.ui.AllBookmarksActivity
import org.haziffe.dropsauce.browser.BrowserActivity
import org.haziffe.dropsauce.browser.cloudflare.CloudFlareActivity
...
import org.haziffe.dropsauce.core.model.appUrl
...
import org.haziffe.dropsauce.core.model.parcelable.ParcelableMangaListFilter
...
import org.haziffe.dropsauce.core.ui.dialog.ErrorDetailsDialog
...
import org.haziffe.dropsauce.details.ui.DetailsActivity
import org.haziffe.dropsauce.details.ui.DetailsClassicActivity
import org.haziffe.dropsauce.details.ui.pager.ChaptersPagesSheet
import org.haziffe.dropsauce.details.ui.related.RelatedMangaActivity
import org.haziffe.dropsauce.details.ui.scrobbling.ScrobblingInfoSheet
import org.haziffe.dropsauce.download.ui.dialog.DownloadDialogFragment
import org.haziffe.dropsauce.download.ui.list.DownloadsActivity
import org.haziffe.dropsauce.favourites.ui.FavouritesActivity
import org.haziffe.dropsauce.favourites.ui.categories.FavouriteCategoriesActivity
import org.haziffe.dropsauce.favourites.ui.categories.edit.FavouritesCategoryEditActivity
import org.haziffe.dropsauce.favourites.ui.categories.select.FavoriteDialog
import org.haziffe.dropsauce.filter.ui.FilterCoordinator
import org.haziffe.dropsauce.filter.ui.sheet.FilterSheetFragment
import org.haziffe.dropsauce.filter.ui.tags.TagsCatalogSheet
import org.haziffe.dropsauce.history.ui.HistoryActivity
import org.haziffe.dropsauce.image.ui.ImageActivity
import org.haziffe.dropsauce.list.ui.config.ListConfigBottomSheet
import org.haziffe.dropsauce.list.ui.config.ListConfigSection
import org.haziffe.dropsauce.local.ui.ImportDialogFragment
import org.haziffe.dropsauce.local.ui.info.LocalInfoDialog
import org.haziffe.dropsauce.main.ui.MainActivity
import org.haziffe.dropsauce.main.ui.welcome.WelcomeSheet
...
import org.haziffe.dropsauce.parsers.util.ellipsize
import org.haziffe.dropsauce.parsers.util.isNullOrEmpty
import org.haziffe.dropsauce.parsers.util.mapToArray
import org.haziffe.dropsauce.reader.ui.colorfilter.ColorFilterConfigActivity
import org.haziffe.dropsauce.reader.ui.config.ReaderConfigSheet
import org.haziffe.dropsauce.scrobbling.common.domain.model.ScrobblerService
import org.haziffe.dropsauce.scrobbling.common.ui.config.ScrobblerConfigActivity
import org.haziffe.dropsauce.scrobbling.common.ui.selector.ScrobblingSelectorSheet
import org.haziffe.dropsauce.search.domain.SearchKind
import org.haziffe.dropsauce.search.ui.MangaListActivity
import org.haziffe.dropsauce.search.ui.multi.SearchActivity
import org.haziffe.dropsauce.settings.SettingsActivity
import org.haziffe.dropsauce.settings.about.AppUpdateActivity
import org.haziffe.dropsauce.settings.override.OverrideConfigActivity
import org.haziffe.dropsauce.settings.reader.ReaderTapGridConfigActivity
import org.haziffe.dropsauce.settings.sources.auth.SourceAuthActivity
import org.haziffe.dropsauce.settings.sources.catalog.SourcesCatalogActivity
import org.haziffe.dropsauce.settings.storage.MangaDirectorySelectDialog
import org.haziffe.dropsauce.settings.storage.directories.MangaDirectoriesActivity
import org.haziffe.dropsauce.settings.tracker.categories.TrackerCategoriesConfigSheet
import org.haziffe.dropsauce.stats.ui.StatsActivity
import org.haziffe.dropsauce.stats.ui.sheet.MangaStatsSheet
import org.haziffe.dropsauce.suggestions.ui.SuggestionsActivity
import org.haziffe.dropsauce.tracker.ui.updates.UpdatesActivity
import java.io.File
...
class AppRouter private constructor(
    ...
    fun openSourcesCatalog(
        mode: org.haziffe.dropsauce.settings.sources.catalog.SourcesCatalogMode? = null,
