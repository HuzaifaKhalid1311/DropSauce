...
class ProgressButton @JvmOverloads constructor(
	...
	init {
		...
		context.withStyledAttributes(attrs, R.styleable.ProgressButton, defStyleAttr) {
			val textAppearanceFallback = appcompatR.style.TextAppearance_AppCompat
	...
	override fun drawableStateChanged() {
		...
		colorProgressCurrent = ColorUtils.setAlphaComponent(colorProgressCurrent, PROGRESS_COLOR_ALPHA)
	...
	companion object {
		private const val PROGRESS_COLOR_ALPHA = 84 // 255 * 0.33F
	}
}
