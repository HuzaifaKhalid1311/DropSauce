...
import org.haziffe.dropsauce.core.exceptions.BadBackupFormatException
import org.haziffe.dropsauce.core.exceptions.CaughtException
...
import org.haziffe.dropsauce.core.exceptions.EmptyMangaException
import org.haziffe.dropsauce.core.exceptions.IncompatiblePluginException
...
import org.haziffe.dropsauce.core.exceptions.ProxyConfigException
import org.haziffe.dropsauce.core.exceptions.SyncApiException
import org.haziffe.dropsauce.core.exceptions.UnsupportedFileException
...
import org.haziffe.dropsauce.parsers.ErrorMessages.FILTER_BOTH_LOCALE_GENRES_NOT_SUPPORTED
import org.haziffe.dropsauce.parsers.ErrorMessages.FILTER_BOTH_STATES_GENRES_NOT_SUPPORTED
import org.haziffe.dropsauce.parsers.ErrorMessages.FILTER_MULTIPLE_GENRES_NOT_SUPPORTED
import org.haziffe.dropsauce.parsers.ErrorMessages.FILTER_MULTIPLE_STATES_NOT_SUPPORTED
import org.haziffe.dropsauce.parsers.ErrorMessages.SEARCH_NOT_SUPPORTED
import org.haziffe.dropsauce.parsers.exception.AuthRequiredException
import org.haziffe.dropsauce.parsers.exception.ContentUnavailableException
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/org.haziffe.dropsauce/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/org.haziffe.dropsauce/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
